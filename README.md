...
- Mobile App Development: React Native, Kotlin, Swift, Flutter
- Backend: Node, PHP, Python, Java, Spring Boot, .NET (.NET Core, ASP.NET Core, Entity Framework)
...
<p>
    <a href="#"><img alt="Cursor" src="https://img.shields.io/badge/Cursor-303030?logo=visualstudiocode&logoColor=white"></a>
